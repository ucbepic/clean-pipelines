...
def compare_models(X_train, X_test, y_train, y_test):
    ...
    for model_name, result in results.items():
        ...
        print(f"Precision (class 1): {result['report'].get('1', result['report'].get(1, {})).get('precision', 0):.4f}")
        print(f"Recall (class 1): {result['report'].get('1', result['report'].get(1, {})).get('recall', 0):.4f}")
        print(f"F1-score (class 1): {result['report'].get('1', result['report'].get(1, {})).get('f1-score', 0):.4f}")
