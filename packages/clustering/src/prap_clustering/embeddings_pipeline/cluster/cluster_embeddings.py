...
def calculate_hybrid_edge_weight(
    doc1: dict, doc2: dict, threshold: float, metadata_source_mode: str = "combined"
) -> float:
    """
...
def cluster_with_threshold_hybrid(
    df: pd.DataFrame, threshold: float, metadata_source_mode: str = "combined"
) -> dict[int, int]:
    """
    ...
    for i in range(len(documents)):
        ...
        if (i + 1) % 1000 == 0:
            logger.info(
                f"    Processed {i + 1}/{len(documents)} documents, {edges_added} edges so far..."
            )
...
def process_threshold_pure(args):
    ...
    output_path = save_clustering_results(
        df, cluster_assignments, threshold, output_dir, mode="pure"
    )
...
def process_threshold_hybrid(args):
    ...
    output_path = save_clustering_results(
        df, cluster_assignments, threshold, output_dir, mode="hybrid"
    )
...
AGENCIES = [
    # {'name': 'Bakersfield Police Department',     'embeddings_csv': _emb('autofolio_1.2.0_output--Bakersfield Police Department--2025-04-09_22-08-24 - autofolio_1.2.0_output--Bakersfield Police Department--2025-04-09_22-08-24_embeddings.csv')},
    {
        ...
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Santa Monica Police Department--2024-12-21_02-18-20 - autofolio_1.1.0_output--Santa Monica Police Department--2024-12-21_02-18-20_embeddings.csv"
        ),
    },
    {
        "name": "Richmond Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--Richmond Police Department--2025-04-09_20-59-59 - autofolio_1.2.0_output--Richmond Police Department--2025-04-09_20-59-59_embeddings.csv"
        ),
    },
    {
        "name": "Los Angeles District Attorney",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Los Angeles District Attorney--2024-11-27_05-47-23 - autofolio_1.1.0_output--Los Angeles District Attorney--2024-11-27_05-47-23_embeddings.csv"
        ),
    },
    {
        "name": "California Department of Justice",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--California Department of Justice--2025-03-28_09-18-52 - autofolio_1.2.0_output--California Department of Justice--2025-03-28_09-18-52_embeddings.csv"
        ),
    },
    {
        "name": "Office of Inspector General for Prisons",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--Office of Inspector General for Prisons--2025-04-27_21-48-50 - autofolio_1.2.0_output--Office of Inspector General for Prisons--2025-04-27_21-48-50_embeddings.csv"
        ),
    },
    {
        "name": "Santa Ana Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Santa Ana Police Department--2025-02-13_01-55-05 - autofolio_1.1.0_output--Santa Ana Police Department--2025-02-13_01-55-05_embeddings.csv"
        ),
    },
    {
        "name": "San Francisco Police Commission",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--San Francisco Police Commission--2025-04-09_21-20-14 - autofolio_1.2.0_output--San Francisco Police Commission--2025-04-09_21-20-14_embeddings.csv"
        ),
    },
    {
        "name": "Kern County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Kern County Sheriff--2024-07-15_23-59-08 - autofolio_1.1.0_output--Kern County Sheriff--2024-07-15_23-59-08_embeddings.csv"
        ),
    },
    {
        "name": "Santa Clara County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Santa Clara County Sheriff--2024-12-13_15-09-21 - autofolio_1.1.0_output--Santa Clara County Sheriff--2024-12-13_15-09-21_embeddings.csv"
        ),
    },
    {
        "name": "Fresno County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Fresno County Sheriff--2024-10-05_00-33-42 - autofolio_1.1.0_output--Fresno County Sheriff--2024-10-05_00-33-42_embeddings.csv"
        ),
    },
    {
        "name": "Sacramento County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Sacramento County Sheriff--2025-03-04_10-11-24 - autofolio_1.1.0_output--Sacramento County Sheriff--2025-03-04_10-11-24_embeddings.csv"
        ),
    },
    {
        "name": "San Francisco County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--San Francisco County Sheriff--2024-07-20_01-57-38 - autofolio_1.1.0_output--San Francisco County Sheriff--2024-07-20_01-57-38_embeddings.csv"
        ),
    },
    {
        "name": "California Department of Corrections and Rehabilitation",
        "embeddings_csv": _emb(
            "OLDautofolio_1.2.0_output--California Department of Corrections and Rehabilitation--2025-03-24_23-57-31 - autofolio_1.2.0_output--California Department of Corrections and Rehabilitation--2025-03-24_23-57-31_embeddings.csv"
        ),
    },
    {
        "name": "Folsom Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Folsom Police Department--2025-02-27_23-14-01 - autofolio_1.1.0_output--Folsom Police Department--2025-02-27_23-14-01_embeddings.csv"
        ),
    },
    {
        "name": "UC Davis Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--UC Davis Police Department--2024-07-20_08-53-00 - autofolio_1.1.0_output--UC Davis Police Department--2024-07-20_08-53-00_embeddings.csv"
        ),
    },
    {
        "name": "Seal Beach Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Seal Beach Police Department--2025-02-13_08-16-22 - autofolio_1.1.0_output--Seal Beach Police Department--2025-02-13_08-16-22_embeddings.csv"
        ),
    },
    {
        "name": "Contra Costa County District Attorney",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Contra Costa County District Attorney--2024-11-06_07-38-04 - autofolio_1.1.0_output--Contra Costa County District Attorney--2024-11-06_07-38-04_embeddings.csv"
        ),
    },
    {
        "name": "Contra Costa County Sheriff",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Contra Costa County Sheriff--2024-12-21_01-47-17 - autofolio_1.1.0_output--Contra Costa County Sheriff--2024-12-21_01-47-17_embeddings.csv"
        ),
    },
    {
        "name": "Shasta County District Attorney",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Shasta County District Attorney--2024-12-18_05-02-13 - autofolio_1.1.0_output--Shasta County District Attorney--2024-12-18_05-02-13_embeddings.csv"
        ),
    },
    {
        "name": "Riverside County Department of Public Social Services",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Riverside County Department of Public Social Services--2024-07-05_20-47-44 - autofolio_1.1.0_output--Riverside County Department of Public Social Services--2024-07-05_20-47-44_embeddings.csv"
        ),
    },
    {
        "name": "Cal State East Bay University Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--Cal State East Bay University Police Department--2025-04-09_20-14-32 - autofolio_1.2.0_output--Cal State East Bay University Police Department--2025-04-09_20-14-32_embeddings.csv"
        ),
    },
    {
        "name": "San Joaquin County Medical Examiner",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--San Joaquin County Medical Examiner--2024-10-24_19-31-44 - autofolio_1.1.0_output--San Joaquin County Medical Examiner--2024-10-24_19-31-44_embeddings.csv"
        ),
    },
    {
        "name": "Pasadena Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Pasadena Police Department--2025-01-24_06-19-29 - autofolio_1.1.0_output--Pasadena Police Department--2025-01-24_06-19-29_embeddings.csv"
        ),
    },
    {
        "name": "Irvine Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Irvine Police Department--2024-07-09_01-45-57 - autofolio_1.1.0_output--Irvine Police Department--2024-07-09_01-45-57_embeddings.csv"
        ),
    },
    {
        "name": "San Diego County Medical Examiner",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--San Diego County Medical Examiner--2025-01-07_23-53-09 - autofolio_1.1.0_output--San Diego County Medical Examiner--2025-01-07_23-53-09_embeddings.csv"
        ),
    },
    {
        "name": "San Leandro Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--San Leandro Police Department--2024-08-15_22-50-51 - autofolio_1.1.0_output--San Leandro Police Department--2024-08-15_22-50-51_embeddings.csv"
        ),
    },
    {
        "name": "Santa Clara Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Santa Clara Police Department--2024-06-01_21-38-12 - autofolio_1.1.0_output--Santa Clara Police Department--2024-06-01_21-38-12_embeddings.csv"
        ),
    },
    {
        "name": "Hayward Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--Hayward Police Department--2025-04-24_18-36-37 - autofolio_1.2.0_output--Hayward Police Department--2025-04-24_18-36-37_embeddings.csv"
        ),
    },
    {
        "name": "Vallejo Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.2.0_output--Vallejo Police Department--2025-03-25_00-20-52 - autofolio_1.2.0_output--Vallejo Police Department--2025-03-25_00-20-52_embeddings.csv"
        ),
    },
    {
        "name": "Chula Vista Police Department",
        "embeddings_csv": _emb(
            "autofolio_1.1.0_output--Chula Vista Police Department--2025-02-20_07-43-22 - autofolio_1.1.0_output--Chula Vista Police Department--2025-02-20_07-43-22_embeddings.csv"
        ),
    },
...
def process_threshold_for_agency(args):
    ...
    df_no_out["Parent Clusters"] = df_no_out["id"].map(lambda i: [singleton_assignments.get(i, -1)])
    ...
    cluster_counts = pd.Series([c[0] for c in df_output["Parent Clusters"]]).value_counts()
    logger.info(
        f"  t={threshold:.2f}: {len(cluster_counts)} clusters, "
...
def cluster_agency(agency: dict, output_dir: str, thresholds: list):
    ...
    logger.info(
        f"  {len(df_with_emb)} docs with embeddings, "
