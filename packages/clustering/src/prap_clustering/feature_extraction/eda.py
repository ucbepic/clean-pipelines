...
def read_tbl():
    ...
    dfa = pd.read_csv(
        "../../data/output/autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52 - autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52_with_extracted_features.csv"
    )
    ...
    dfb = pd.read_csv(
        "../../data/input/autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52 - autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52.csv"
    )
...
if __name__ == "__main__":
    df = read_tbl()
    df.to_csv(
        "../../data/output/autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52 - autofolio_1.1.0_output--Tulare County Sheriff--2024-12-21_01-12-52_ocr_col_dropped.csv",
        index=False,
    )
